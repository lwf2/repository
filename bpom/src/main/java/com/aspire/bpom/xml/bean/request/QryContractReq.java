 ...
 *
 */
@XmlRootElement(name = "QryContractReq")
@XStreamAlias("QryContractReq")
public class QryContractReq implements Serializable {

	private static final long serialVersionUID = 6534446639290202576L;
	...
	public String toString() {
		return "QryContractReq [MsgType=" + MsgType + ", Version=" + Version
				+ ", systemCode=" + systemCode + ", wxPlan_id=" + wxPlan_id
				+ ", contractCode=" + contractCode + ", hmac=" + hmac + "]";
	}
